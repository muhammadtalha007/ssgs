            ...
            <div class="inbox_msg">
                <div class="inbox_people">
                    ...
                    <div class="inbox_chat">
                        <h4 style="text-align: center;margin-top: 30px">Customer: <span
                                style="font-weight: bold">{{$customerName ?? $customerNumber}}</span></h4>
                        <h4 style="text-align: center">Chat Staff: @foreach($chatMembers as $members) <span
                                style="font-weight: bold">{{$members->sender}},<br></span> @endforeach</h4>
                    </div>
                </div>
                <div class="mesgs">
                                ...
                                <div class="incoming_msg" style="margin-bottom: 10px">
                                    ...
                                    <div class="received_msg">
                                        <div class="received_withd_msg">
                                            <p><span
                                                    style="text-decoration: underline"> {{\App\Customer::where('number', $chat->sender)->first()['name'] ?? $chat->sender}}</span><br>{{$chat->message}}
                                            </p>
                                            <span
