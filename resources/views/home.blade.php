                    ...
                    <div class="col-12 col-sm-6 col-xl-3 media_max_573">
                        <div id="top_widget2">
                            <div class="bg-success p-d-15 b_r_5">
                                ...
                                <div class="user_font">Courses</div>
                                <div id="widget_countup2">{{$totalCourses}}</div>
                                <div class="tag-white">
{{--                                    <span id="percent_count2">60</span>%--}}
                                </div>
                                <div class="previous_font">Total Courses</div>
                            </div>
                        </div>
{{--                        <div class="back">--}}
{{--                            <div class="front">--}}
...
{{--                                        </div>--}}
{{--                                        <div id="widget_countup22">{{$totalCourses}}</div>--}}
{{--                                        <div>Courses</div>--}}
{{--                                    </div>--}}
{{--                                    <div class="row">--}}
{{--                                        <div class="col-lg-12">--}}
                        ...
                        <div id="top_widget3">
                            <div class="front">
                                <div class="bg-warning p-d-15 b_r_5">
                                    ...
                                    <div class="user_font">Students</div>
                                    <div id="widget_countup3">{{$totalStudents}}</div>
                                    <div class="tag-white ">
{{--                                        <span id="percent_count3">30</span>%--}}
                                    </div>
                                    <div class="previous_font">Total Students</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-xl-3 media_max_1199">
                        <div id="top_widget2">
                            <div class="bg-success p-d-15 b_r_5">
                                ...
                                <div class="user_font">Families</div>
                                <div id="widget_countup2">{{$totalFamilies}}</div>
                                <div class="tag-white">
                                    {{--                                    <span id="percent_count2">60</span>%--}}
                                </div>
                                <div class="previous_font">Total Families</div>
                            </div>
                        </div>
                    </div>
